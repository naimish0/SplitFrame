...
class VideoExportWorker(
    ...
    private fun createForegroundInfo(progress: Int): ForegroundInfo {
        ...
        val notification = NotificationCompat.Builder(applicationContext, NotificationChannelId)
            .setContentTitle(applicationContext.getString(R.string.video_export_background_title))
            .setContentText(applicationContext.getString(R.string.video_export_background_body))
            ...
            .build()
        val foregroundId = foregroundStatusId(id.toString())
        return when (val serviceType = videoExportForegroundServiceType(Build.VERSION.SDK_INT)) {
            null -> ForegroundInfo(foregroundId, notification)
            else -> ForegroundInfo(
                foregroundId,
                notification,
                serviceType,
    ...
    companion object {
        ...
        private const val ForegroundStatusBase = 0x1000_0000
        private const val ForegroundStatusHashMask = 0x0FFF_FFFF
        ...
        private fun foregroundStatusId(workId: String): Int =
            ForegroundStatusBase or (workId.hashCode() and ForegroundStatusHashMask)
    }
}
